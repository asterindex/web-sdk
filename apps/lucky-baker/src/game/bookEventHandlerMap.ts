...
const winLevelSoundsStop = () => {
	...
	if (stateBet.activeBetModeKey === 'feature_spins' || stateGame.gameType === 'freegame') {
...
export const bookEventHandlerMap: BookEventHandlerMap<BookEvent, BookEventContext> = {
	...
	wincap: async () => {
		// Max-win cap is enforced in math; no separate FE animation required.
	},
	...
	boardMultiplierInfo: async () => {
		// Lucky Baker uses wildSpawnInfo + global mult, not board M-symbols.
	},
	wildSpawnInfo: async (bookEvent: BookEventOfType<'wildSpawnInfo'>) => {
		await eventEmitter.broadcastAsync({
			type: 'wildSpawnAnimate',
			wildInfo: bookEvent.wildInfo,
		});
	},
